package com.mafra.hexagonal.architecture;
...
@AnalyzeClasses(packages = "com.mafra.hexagonal")
public class NamingConventionTest
{
	...
	// os .. serve para pegar mais pacotes seja antes ou depois (Dependendo de onde for colocado)
	@ArchTest
	public static final ArchRule mapper_reside_only_mapper_package = classes()
		...
		.resideInAnyPackage("..adapters.in.consumer.mapper",
			"..adapters.in.controller.mapper","..adapters.out.client.mapper", "..adapters.out.repository.mapper")
		.as("Mapper classes should residen inside mapper package in controller, client, consumer and repository");
	...
	// Testes para as classes serem criadas com sufixos corretos (Consumer, Adapter, Output, Input, etc)
	@ArchTest
